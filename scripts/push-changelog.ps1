...
.DESCRIPTION
  ...
  index.html and/or data/claude-desktop.json. Pulls latest, stages changed files,
...
.PARAMETER Message
  ...
  (e.g. "Claude Code +2, Claude Desktop +1, Codex CLI +1, Codex App +3").

.EXAMPLE
  pwsh scripts/push-changelog.ps1 -Message "Claude Code +2 筆、Claude Desktop +1 筆、Codex CLI +1 筆、Codex App +0 筆"
#>
[CmdletBinding()]
param(
  [string]$Message = ""
